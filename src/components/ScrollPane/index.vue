<!--/*
 * @Author: potstar 
 * @Date: 2020-03-11 16:50:55 
 * @Last Modified by:   potstar 
 * @Last Modified time: 2020-03-11 16:50:55 
 */
 滚动组件 在view/layout/components/tagesview.vue引用
-->
<template>
    <div ref="scrollContainer" 
         class="scrool-container"
...
export default {
    ...
    methods:{
        handelScroll(e){
            const eventDelta=e.whellDelta || -e.deltaY*3;
